...
#  @author: parkdj1
#
#  create heatmaps of up/down-regulated genes from deseq and norm counts data
#
...
deseq_file <- "PATH/TO/PAIRED_READS.csv"
...
# parameters
basemean_limit <- 100
up_log2FoldChange_limit <- 1
down_log2FoldChange_limit <- -1
padj_limit <- 0.01
